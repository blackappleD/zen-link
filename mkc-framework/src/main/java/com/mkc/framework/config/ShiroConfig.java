...
import com.mkc.framework.shiro.web.CustomShiroFilterFactoryBean;
import com.mkc.framework.shiro.web.filter.LogoutFilter;
import com.mkc.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import com.mkc.framework.shiro.web.filter.kickout.KickoutSessionFilter;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/xh.png**", "anon");
		...
		filterChainDefinitionMap.put("/mkc/**", "anon");
		filterChainDefinitionMap.put("/xh/**", "anon");
	...
	public CookieRememberMeManager rememberMeManager() {
		CookieRememberMeManager cookieRememberMeManager = new CookieRememberMeManager() {
			...
			protected PrincipalCollection convertBytesToPrincipals(byte[] bytes, SubjectContext subjectContext) {
				...
				String currIp = subjectContext.resolveHost();
				String loginIp = sysUser.getLoginIp();
				if(!currIp.equals(loginIp)) {
					throw new RuntimeException("rememberMe - 记住我时的IP(" + loginIp + ")与当前访问IP(" + currIp + ")不匹配，请重新登陆！");
				}
