...
import com.mkc.common.core.domain.entity.SysMenu;
import com.mkc.common.core.domain.entity.SysUser;
import com.mkc.common.core.text.Convert;
import com.mkc.common.utils.CookieUtils;
...
public class SysIndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", MkcConfig.getCopyrightYear());
        mmap.put("demoEnabled", MkcConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", MkcConfig.getVersion());
        return "main";
    }
