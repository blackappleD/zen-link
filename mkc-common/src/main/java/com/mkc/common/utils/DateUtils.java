...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils
{
    ...
    public static String YYYYMMDDHHMMSS_SSS = "yyyyMMddHHmmssSSS";
    ...
    public static final String dateTimeNow_SSS()
    {
        return dateTimeNow(YYYYMMDDHHMMSS_SSS);
    }
     ...
     * @return
     */
    public static final boolean isDateTime(final String format, final String ts)
    {
        try
        {
