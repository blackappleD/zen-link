package com.mkc.common.core.redis;
...
public class RedisCache {
	...
	public static Integer DEFAULT_OUTTIME = 24 * 60;
	@Autowired
	...
	public <T> void setCacheObject(final String key, final T value) {
		redisTemplate.opsForValue().set(key, value, DEFAULT_OUTTIME, TimeUnit.MINUTES);
	}
	 ...
	 * @param hkey
	 */
	public Long deleteHash(final String key, final String hkey) {
	...
	public <T> void setCacheMap(final String key, final Map<String, T> dataMap) {
		if (dataMap != null) {
			...
			expire(key, DEFAULT_OUTTIME, TimeUnit.MINUTES);
		}
	}
	...
	/**
	 * 往Hash中存入数据 过期时间 DEFAULT_OUTTIME 24 * 60分钟
	 *
	 * @param key   Redis键
	 * @param hKey  Hash键
	 * @param value 值
	...
	public <T> void setCacheMapValue(final String key, final String hKey, final T value, final Long timeout, TimeUnit timeunit) {
		redisTemplate.opsForHash().put(key, hKey, value);
	...
	public boolean tryLock(String key) {
		Boolean flag = redisTemplate.opsForValue().setIfAbsent(key, "1", 120, TimeUnit.MINUTES);
