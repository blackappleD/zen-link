...
public class SM4 {
	...
	public static void main(String[] args) throws IOException {
		...
		SM4 sm4 = new SM4();
		sm4.secretKey = "JeF8U9wHFOMfs2Y8";//secret前16位
		sm4.hexString = false;
	...
	public String decryptDataToString_CBC(String cipherText) {
		return decryptDataToString_CBC(cipherText, "UTF-8");
	}
	...
	public String decryptDataToString_ECB(String cipherText) {
		...
		return decryptDataToString_ECB(cipherText, "UTF-8");
	}
	...
	public String encryptDataToString_CBC(String plainText) {
		return encryptDataToString_CBC(plainText, "UTF-8");
	}
...
//		}
	...
	public byte[] encryptData_ECB(String plainText) {
		return encryptData_ECB(plainText, "UTF-8");
	}
	...
	public String encryptDataToString_ECB(String plainText) {
		...
		return encryptDataToString_ECB(plainText, "UTF-8");
	}
